module.exports = {
  ...
  async execute(sock, msg, args) {
    ...
    if (!newName) return sock.sendMessage(msg.key.remoteJid, { text: '❌ Provide a new group name.' });
    try {
      ...
      await sock.sendMessage(msg.key.remoteJid, { text: '❌ Failed to update group name.' });
    }
  }
};